    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="w-full h-full bg-gray-800"> {/* Añadido color de fondo como respaldo */}
          <img 
            ...
            onError={(e) => {
              ...
              target.onerror = null;
              target.src = 'https://images.pexels.com/photos/159490/yale-university-landscape-universities-schools-159490.jpeg';
            }}
          />
        </div>
      ...
      <div className="container mx-auto px-6 py-16 relative z-20">
        ...
        >
          ...
          >
            Descubre la historia, la misión y los valores del Instituto Universitario de Tecnología de Cumaná.
          </motion.p>
