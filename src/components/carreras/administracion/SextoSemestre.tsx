      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Sexto Semestre Administración" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/3184296/pexels-photo-3184296.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Sexto Semestre<br />
              <span className="text-secondary">TSU en Administración de Empresas</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del sexto semestre de la carrera de Técnico Superior Universitario en Administración de Empresas
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El sexto semestre representa la culminación de tu formación académica como Técnico Superior Universitario en Administración de Empresas, donde pondrás en práctica todos los conocimientos adquiridos durante la carrera.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <p className="text-gray-700">Técnico Superior Universitario en Administración de Empresas</p>
              </motion.div>
            </motion.div>
          </motion.div>
        </div>
              ...
              <div className="flex items-start mb-6">
                ...
                <div>
                  ...
                  <p className="text-lg mb-4">
                    Las pasantías profesionales representan la culminación de tu formación académica como Técnico Superior Universitario en Administración de Empresas. Durante este período, aplicarás todos los conocimientos y habilidades adquiridos a lo largo de la carrera en un entorno empresarial real.
                  </p>
                  <p className="text-lg mb-4">
                    Nuestros estudiantes realizan sus pasantías en empresas e instituciones reconocidas del sector empresarial, donde tienen la oportunidad de integrarse a equipos de trabajo profesionales y participar en la gestión y desarrollo de proyectos administrativos significativos.
                  </p>
              ...
              <div className="mt-8 bg-white/5 p-6 rounded-lg">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span>Experiencia laboral real en el sector empresarial y administrativo</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheckCircle className="mr-3 text-secondary mt-1" />
                    <span>Aplicación práctica de conocimientos teóricos en gestión empresarial</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheckCircle className="mr-3 text-secondary mt-1" />
                    <span>Desarrollo de habilidades gerenciales, administrativas y de liderazgo</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheckCircle className="mr-3 text-secondary mt-1" />
                    <span>Oportunidades de empleo y crecimiento profesional al finalizar la carrera</span>
                  </li>
                  <li className="flex items-start">
                    <FaCheckCircle className="mr-3 text-secondary mt-1" />
                    <span>Creación de red de contactos profesionales en el ámbito empresarial</span>
                  </li>
                </ul>
              </div>
            </motion.div>
