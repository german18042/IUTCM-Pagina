...
export const TercerSemestre = () => {
  ...
  const materias = [
    "PROCESAMIENTO ELECTRÓNICO DE DATOS (ADMINISTRACIÓN)",
    "ADMINISTRACIÓN PÚBLICA",
    "TEORÍA ECONÓMICA II",
    "DERECHO LABORAL",
    "MATEMÁTICA FINANCIERA",
    "ANÁLISIS DE SISTEMAS (ADMINISTRACIÓN)",
    "CONTABILIDAD II",
    "ESTADÍSTICA I"
  ];
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Tercer Semestre Administración" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/3184306/pexels-photo-3184306.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Desarrollo Académico del tercer semestre de la carrera de Técnico Superior Universitario en Administración de Empresas
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              En el tercer semestre, profundizarás en conocimientos especializados de administración, contabilidad y sistemas, adquiriendo herramientas fundamentales para la gestión empresarial moderna.
            </motion.p>
