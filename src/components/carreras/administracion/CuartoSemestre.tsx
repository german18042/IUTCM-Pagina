      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Cuarto Semestre Administración" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/3184339/pexels-photo-3184339.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Desarrollo Académico del cuarto semestre de la carrera de Técnico Superior Universitario en Administración de Empresas
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El cuarto semestre te introduce en áreas avanzadas de la administración empresarial, con enfoque en planificación estratégica, gestión de recursos humanos y análisis de mercado, preparándote para roles de mayor responsabilidad.
            </motion.p>
