...
export const QuintoSemestre = () => {
  ...
  const materias = [
    ...
    "ADMINISTRACIÓN DE PLANTAS Y OPERACIONES",
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Quinto Semestre Administración" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/3182773/pexels-photo-3182773.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Desarrollo Académico del quinto semestre de la carrera de Técnico Superior Universitario en Administración de Empresas
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El quinto semestre profundiza en áreas especializadas como la formulación de proyectos, administración financiera y producción, preparándote para la gestión integral de empresas con un enfoque práctico y orientado a resultados.
            </motion.p>
