...
import { FaLaptopCode, FaDatabase, FaServer, FaNetworkWired, FaCode, FaIndustry, FaUniversity, FaHospital, FaBuilding, FaLeaf, FaPlane, FaShoppingBag } from 'react-icons/fa';
import Link from 'next/link';
import { Button } from '../../../components/ui/Button';

export const InformaticaDetalle = () => {
  const fadeIn = {
  ...
  const capacidades = [
    { icon: <FaCode />, texto: "Programación" },
    { icon: <FaLaptopCode />, texto: "Análisis y diseño de Sistemas de Información" },
    { icon: <FaDatabase />, texto: "Base de Datos" },
    { icon: <FaServer />, texto: "Páginas Web" },
    { icon: <FaNetworkWired />, texto: "Sistemas Operativos (Privativo y Software Libre)" },
    { icon: <FaLaptopCode />, texto: "Mantenimiento (Preventivo y Correctivo) de sistemas" },
    { icon: <FaNetworkWired />, texto: "Redes de computadoras en el ámbito local" }
  ];

  const industrias = [
    { icon: <FaIndustry />, texto: "Industrias" },
    { icon: <FaUniversity />, texto: "Instituciones Educativas" },
    { icon: <FaBuilding />, texto: "Instituciones Bancarias" },
    { icon: <FaHospital />, texto: "Instituciones de Salud" },
    { icon: <FaBuilding />, texto: "Empresas de Servicios" },
    { icon: <FaLeaf />, texto: "Empresas Agropecuarias" },
    { icon: <FaPlane />, texto: "Empresas Turísticas" },
    { icon: <FaShoppingBag />, texto: "Empresas Comerciales" }
  ];
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800"> {/* Color de fondo como respaldo */}
            <img 
              ...
              alt="Carrera de Informática IUTCM" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/1181467/pexels-photo-1181467.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              ...
              <span className="text-secondary">Informática</span>
            </motion.h1>
            ...
            >
              El Técnico Superior Universitario en Informática es un profesional capacitado técnicamente para desempeñarse eficaz y eficientemente en las áreas específicas de análisis, diseño e implantación de sistemas de información gerencial.
            </motion.p>
        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-lg text-gray-100 mb-8">
              El campo laboral del Técnico Superior Universitario en Informática ofrece oportunidades similares a las de un Licenciado en Informática, pero con la ventaja de una inserción más temprana en el mercado laboral. Su enfoque se centra en desempeñar funciones técnicas en áreas funcionales de informática y desarrollo de sistemas en instituciones públicas y privadas.
            </p>
            ...
            >
              {capacidades.map((cap, index) => (
                <motion.div 
                  key={index} 
                  className="bg-white/10 backdrop-blur-sm p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex items-start gap-4"
                  variants={fadeIn}
                >
                  <div className="text-secondary text-2xl mt-1">{cap.icon}</div>
                  <div>
                    <p className="font-medium text-white">{cap.texto}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
              ...
              {semestres.map((semestre, index) => (
                ...
                >
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200 text-center">
                    <Link 
                      href={`/carreras/1/semestre/${semestre.numero === 'I' ? '1' : semestre.numero === 'II' ? '2' : semestre.numero === 'III' ? '3' : semestre.numero === 'IV' ? '4' : semestre.numero === 'V' ? '5' : '6'}`} 
