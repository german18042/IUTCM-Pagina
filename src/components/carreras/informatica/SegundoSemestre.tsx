...
export const SegundoSemestre = () => {
  ...
  const materias = [
    ...
    "CONTABILIDAD I",
    "MATEMÁTICAS II",
    "Introducción a la Informática y Electrónica"
  ];
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Segundo Semestre Informática" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/4050315/pexels-photo-4050315.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Desarrollo Académico del segundo semestre de la carrera de Técnico Superior Universitario en Informática
            </motion.p>
