...
export const PrimerSemestre = () => {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Primer Semestre Informática" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/4050291/pexels-photo-4050291.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Desarrollo Académico del primer semestre de la carrera de Técnico Superior Universitario en Informática
            </motion.p>
      ...
      {/* Materias */}
      <section id="materias" className="relative py-16 bg-gradient-to-r from-primary via-primary/95 to-primary overflow-hidden text-white">
