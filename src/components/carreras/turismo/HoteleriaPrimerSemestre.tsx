...
export const HoteleriaPrimerSemestre = () => {
  const fadeIn = {
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Primer Semestre Hotelería" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/2507007/pexels-photo-2507007.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Primer Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN HOTELERÍA I</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del primer semestre de la carrera de Técnico Superior Universitario en Turismo Mención Hotelería
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El primer semestre de la carrera de TSU en Turismo Mención Hotelería establece las bases fundamentales para tu formación profesional. Desarrollarás habilidades en metodología de investigación, matemáticas, comunicación e idiomas, complementadas con formación cultural, ecológica y deportiva, preparándote para comprender el contexto socioeconómico venezolano y su relación con el sector hotelero.
            </motion.p>
