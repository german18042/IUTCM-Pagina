...
export const HoteleriaTercerSemestre = () => {
  const fadeIn = {
  ...
  const materias = [
    ...
    "GEOGRAFÍA TURÍSTICA DE VENEZUELA I",
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Tercer Semestre Hotelería" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/2034335/pexels-photo-2034335.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Tercer Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN HOTELERÍA III</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del tercer semestre de la carrera de Técnico Superior Universitario en Turismo Mención Hotelería
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El tercer semestre de la carrera de TSU en Turismo Mención Hotelería se enfoca en aspectos especializados de la gestión hotelera y turística. Desarrollarás competencias en mercadeo turístico, presupuesto, legislación turística y administración de empresas hoteleras, complementadas con conocimientos en geografía turística de Venezuela, computación y el fortalecimiento continuo del idioma inglés.
            </motion.p>
            ...
            >
              Este semestre te brinda herramientas prácticas para la gestión y promoción de servicios hoteleros, así como el marco legal y geográfico necesario para desarrollar actividades turísticas en Venezuela, preparándote para roles de mayor responsabilidad en la industria.
            </motion.p>
