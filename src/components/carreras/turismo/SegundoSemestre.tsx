      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Segundo Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN SERVICIOS TURISTICOS II</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del segundo semestre de la carrera de Técnico Superior Universitario en Turismo Mención Servicios Turísticos
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El segundo semestre de la carrera de TSU en Turismo Mención Servicios Turísticos profundiza en la animación y recreación turística, teoría y técnica del turismo, y sociología del turismo, además de fortalecer tus conocimientos en contabilidad, matemática financiera y teoría económica aplicada al sector turístico.
            </motion.p>
