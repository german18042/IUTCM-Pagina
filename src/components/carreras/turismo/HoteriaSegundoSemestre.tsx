...
export const HoteriaSegundoSemestre = () => {
  const fadeIn = {
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Segundo Semestre Hotelería" 
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Segundo Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN HOTELERÍA II</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del segundo semestre de la carrera de Técnico Superior Universitario en Turismo Mención Hotelería
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El segundo semestre de la carrera de TSU en Turismo Mención Hotelería profundiza en los aspectos específicos del sector turístico y hotelero. Desarrollarás conocimientos en animación y recreación turística, administración, economía del turismo, contabilidad y matemática financiera, complementados con la continuación de tu formación deportiva y el fortalecimiento de tus habilidades en inglés.
            </motion.p>
            ...
            >
              Este semestre te brinda las herramientas fundamentales para comprender la teoría y técnica del turismo, así como los aspectos económicos y administrativos esenciales para la gestión hotelera, preparándote para los desafíos prácticos de la industria.
            </motion.p>
