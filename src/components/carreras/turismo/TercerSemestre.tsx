      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Tercer Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN SERVICIOS TURISTICOS III</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del tercer semestre de la carrera de Técnico Superior Universitario en Turismo Mención Servicios Turísticos
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El tercer semestre de la carrera de TSU en Turismo Mención Servicios Turísticos se enfoca en la administración de empresas turísticas, presupuesto y contabilidad aplicada, además de introducirte a la computación, geografía turística de Venezuela y estadística, fortaleciendo tus habilidades para la gestión efectiva de servicios turísticos.
            </motion.p>
