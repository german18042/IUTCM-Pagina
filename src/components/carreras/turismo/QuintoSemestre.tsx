...
export const QuintoSemestre = () => {
  ...
  const materias = [
    ...
    "TÉCNICAS DE OPERACIONES DE EMPRESAS TURÍSTICAS II",
    "TRÁFICO AÉREO"
  ];
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Quinto Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN SERVICIOS TURISTICOS V</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del quinto semestre de la carrera de Técnico Superior Universitario en Turismo Mención Servicios Turísticos
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El quinto semestre de la carrera de TSU en Turismo Mención Servicios Turísticos se enfoca en la administración de recursos turísticos, contratación de servicios, formulación de proyectos y análisis financiero, además de desarrollar habilidades prácticas en diseño de rutas turísticas, programación de eventos y tráfico aéreo, preparándote para roles especializados en el sector.
            </motion.p>
