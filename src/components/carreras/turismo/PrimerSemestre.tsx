      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Primer Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN SERVICIOS TURISTICOS I</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del primer semestre de la carrera de Técnico Superior Universitario en Turismo Mención Servicios Turísticos
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El primer semestre de la carrera de TSU en Turismo Mención Servicios Turísticos te introduce a metodología de investigación, matemáticas, formación ecológica e historia socio-económica de Venezuela, además de desarrollar habilidades esenciales en idiomas, educación física y formación cultural que serán la base para tu formación profesional.
            </motion.p>
