...
export const HoteleriaCuartoSemestre = () => {
  const fadeIn = {
  ...
  const materias = [
    "TECNICAS DE OPERACIONES HOTELERAS I",
    "PROMOCION TURISTICA",
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              src="https://images.pexels.com/photos/3760958/pexels-photo-3760958.jpeg" 
              alt="Cuarto Semestre Hotelería" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/1457842/pexels-photo-1457842.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Cuarto Semestre<br />
              <span className="text-secondary">TSU TURISMO MENCIÓN HOTELERÍA IV</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del cuarto semestre de la carrera de Técnico Superior Universitario en Turismo Mención Hotelería
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El cuarto semestre de la carrera de TSU en Turismo Mención Hotelería profundiza en las operaciones hoteleras y la gestión de eventos. Desarrollarás habilidades prácticas en técnicas de operaciones hoteleras, promoción turística, administración de personal y programación de eventos, complementadas con conocimientos avanzados de geografía turística venezolana y un nivel superior de inglés.
            </motion.p>
            ...
            >
              Este semestre te prepara para asumir responsabilidades en la gestión operativa de establecimientos hoteleros, la planificación y ejecución de eventos, así como la promoción efectiva de servicios turísticos, acercándote a la práctica profesional real del sector.
            </motion.p>
