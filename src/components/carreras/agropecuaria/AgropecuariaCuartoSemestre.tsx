...
export const AgropecuariaCuartoSemestre = () => {
  const fadeIn = {
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Cuarto Semestre Agropecuaria" 
              className="w-full h-full object-cover opacity-90"
              loading="eager"
              onError={(e) => {
                const target = e.target as HTMLImageElement;
                target.onerror = null;
                target.src = 'https://images.pexels.com/photos/2255459/pexels-photo-2255459.jpeg';
              }}
            />
          </div>
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Cuarto Semestre<br />
              <span className="text-secondary">TSU ADMINISTRACIÓN DE EMPRESAS AGROPECUARIAS IV</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del cuarto semestre de la carrera de Técnico Superior Universitario en Administración de Empresas Agropecuarias
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El cuarto semestre de la carrera de TSU en Administración de Empresas Agropecuarias profundiza en aspectos técnicos y especializados del sector, con un enfoque en la sanidad animal y vegetal, la producción agropecuaria y la contabilidad específica del sector. Durante este período, adquirirás conocimientos avanzados sobre la gestión de la salud de cultivos y animales, así como sobre la producción agropecuaria sostenible.
            </motion.p>
            ...
            >
              Este semestre integra también aspectos ambientales y económicos cruciales para el sector, como la ecología y contaminación ambiental y la economía política agrícola, proporcionándote una visión holística de la producción agropecuaria que considera tanto la rentabilidad como la sostenibilidad. Además, continúas desarrollando habilidades estadísticas avanzadas para el análisis de datos en el contexto agropecuario.
            </motion.p>
