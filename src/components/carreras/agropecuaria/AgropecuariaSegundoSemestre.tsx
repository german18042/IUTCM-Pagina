...
export const AgropecuariaSegundoSemestre = () => {
  const fadeIn = {
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Segundo Semestre Agropecuaria" 
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Segundo Semestre<br />
              <span className="text-secondary">TSU ADMINISTRACIÓN DE EMPRESAS AGROPECUARIAS II</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del segundo semestre de la carrera de Técnico Superior Universitario en Administración de Empresas Agropecuarias
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El segundo semestre de la carrera de TSU en Administración de Empresas Agropecuarias profundiza en aspectos legales, económicos y organizativos del sector agrícola. Durante este período, adquirirás conocimientos especializados sobre cooperativas y sociedades agrícolas, contabilidad, matemática financiera y derecho agrario, que son fundamentales para la gestión eficiente de empresas del sector.
            </motion.p>
            ...
            >
              Este semestre te brinda las herramientas necesarias para comprender el marco legal y económico en el que operan las empresas agropecuarias, así como los principios contables y financieros aplicables al sector. Además, continúas desarrollando habilidades físicas y de comunicación en inglés, complementando tu formación integral como futuro profesional del sector agropecuario.
            </motion.p>
      ...
      <section id="materias" className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-center mb-12">Materias del Segundo Semestre</h2>
