...
export const AgropecuariaPrimerSemestre = () => {
  const fadeIn = {
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-gray-800">
            <img 
              ...
              alt="Primer Semestre Agropecuaria" 
        ...
        <div className="container mx-auto px-6 py-16 relative z-20">
          ...
          >
            ...
            >
              Primer Semestre<br />
              <span className="text-secondary">TSU ADMINISTRACIÓN DE EMPRESAS AGROPECUARIAS I</span>
            </motion.h1>
            ...
            >
              Desarrollo Académico del primer semestre de la carrera de Técnico Superior Universitario en Administración de Empresas Agropecuarias
            </motion.p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              El primer semestre de la carrera de TSU en Administración de Empresas Agropecuarias está diseñado para proporcionar una base sólida en conocimientos fundamentales que serán esenciales para tu desarrollo profesional. Durante este semestre, adquirirás competencias básicas en matemáticas, metodología de investigación, comunicación, idiomas y comprensión del contexto socioeconómico y ecológico venezolano.
            </motion.p>
            ...
            >
              Este semestre inicial te brinda las herramientas necesarias para comprender el entorno en el que se desarrollan las actividades agropecuarias, con un enfoque integral que combina aspectos técnicos, culturales y ecológicos, preparándote para los conocimientos más especializados que adquirirás en semestres posteriores.
            </motion.p>
      ...
      <section id="materias" className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="text-3xl font-bold text-center mb-12">Materias del Primer Semestre</h2>
