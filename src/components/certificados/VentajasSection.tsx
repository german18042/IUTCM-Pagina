...
export const VentajasSection = () => {
  const ventajas = [
    ...
    },
    {
      ...
      descripcion: "Respaldados por tecnología blockchain, garantizando la autenticidad y seguridad de tus certificados.",
      icono: (
        <svg className="w-12 h-12 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-200 max-w-2xl mx-auto">
            ...
            respaldados por Blockchain y reconocidos en todo el mundo.
          </p>
        </motion.div>
